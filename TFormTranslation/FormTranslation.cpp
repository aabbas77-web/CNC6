...
//            continue;
        ...
        if(pLabeledEdit)
        {
            ...
            pLabeledEdit->BiDiMode = m_BiDiMode;
    		if(bFlipChildren)
            {
        ...
        if(pCustomLabel)
        {
            ...
            pCustomLabel->BiDiMode = m_BiDiMode;
            if(bFlipChildren)
            {
    	...
    	if(pCustomEdit)
	    {
	        ...
	        pCustomEdit->BiDiMode = m_BiDiMode;
    		if(bFlipChildren)
            {
    	...
    	if(pQRSysData)
	    {
	        ...
	        pQRSysData->BiDiMode = m_BiDiMode;
            if(bFlipChildren)
            {
          ...
          )
        {
	    	...
	    	if(pQRPrintable)
		    {
		        pQRPrintable->BiDiMode = m_BiDiMode;
	            if(bFlipChildren)
	            {
        ...
        if(pStaticText)
        {
            ...
            pStaticText->BiDiMode = m_BiDiMode;
            if(bFlipChildren)
            {
        ...
        if(pSpeedButton)
        {
            ...
            pSpeedButton->BiDiMode = m_BiDiMode;
            if(bFlipChildren)
            {
        ...
        if(pToolButton)
        {
            ...
            pToolButton->BiDiMode = m_BiDiMode;
            if(bFlipChildren)
            {
        ...
        if(pDBCheckBox)
        {
            ...
            pDBCheckBox->BiDiMode = m_BiDiMode;
            if(bFlipChildren)
            {
        ...
        if(pRadioButton)
        {
            ...
            pRadioButton->BiDiMode = m_BiDiMode;
            if(bFlipChildren)
            {
        ...
        if(pGroupBox)
        {
            ...
            pGroupBox->BiDiMode = m_BiDiMode;
            if(bFlipChildren)
            {
            	FlipAnchor(pGroupBox);
				pGroupBox->FlipChildren(true);
            }
            continue;
        }
        ...
        if(pRadioGroup)
        {
            ...
            pRadioGroup->BiDiMode = m_BiDiMode;
        ...
        if(pCheckListBox)
        {
            ...
            if(bFlipChildren)
            {
				...
				pCheckListBox->FlipChildren(true);
            }
            continue;
        }
        ...
        if(pDBRadioGroup)
        {
            ...
            pDBRadioGroup->BiDiMode = m_BiDiMode;
            if(bFlipChildren)
            {
            	FlipAnchor(pDBRadioGroup);
				pDBRadioGroup->FlipChildren(true);
            }
            continue;
        }
        ...
        if(pPanel)
        {
            ...
            pPanel->BiDiMode = m_BiDiMode;
            if(bFlipChildren)
            {
            	FlipAnchor(pPanel);
				pPanel->FlipChildren(true);
            }
            continue;
        }
