...
#pragma option push -b-
enum TComLedSignal { lsCTS, lsDSR, lsRLSD, lsRing, lsRx, lsTx };
#pragma option pop
...
typedef void __fastcall (__closure *TRxStrEvent)(System::TObject* Sender, AnsiString Str);
...
private:
	...
	void __fastcall SendSignals(TComLedSignal Signal, bool OnOff);
...
public:
	...
	int __fastcall WriteStr(AnsiString Str);
	...
	int __fastcall WriteStrAsync(AnsiString Str, PAsync &AsyncPtr);
	...
	void __fastcall WaitForEvent(TComEvents &Events, int Timeout);
	...
	__property bool TriggersOnRxChar = {read=GetTriggersOnRxChar, nodefault};
...
private:
	...
	bool FInPacket;
	AnsiString FBuffer;
	TRxStrEvent FOnPacket;
	TRxStrEvent FOnDiscard;
	...
	AnsiString __fastcall Upper(AnsiString Str);
	void __fastcall EmptyBuffer(void);
	
protected:
	virtual void __fastcall Notification(Classes::TComponent* AComponent, Classes::TOperation Operation
		);
	DYNAMIC void __fastcall DoDiscard(AnsiString Str);
	DYNAMIC void __fastcall DoPacket(AnsiString Str);
...
__published:
	...
	__property TRxStrEvent OnDiscard = {read=FOnDiscard, write=FOnDiscard};
	__property TRxStrEvent OnPacket = {read=FOnPacket, write=FOnPacket};
};
...
static const Shortint CError_SyncMeth = 0xe;
