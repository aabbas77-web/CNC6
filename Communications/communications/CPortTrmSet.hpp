...
// (DO NOT EDIT: machine generated header) 'CPortTrmSet.pas' rev: 5.00
...
public:
	...
	/* TCustomForm.Create */ inline __fastcall virtual TComTrmSetForm(Classes::TComponent* AOwner) : Forms::TForm(
		AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
	/* TCustomForm.CreateNew */ inline __fastcall virtual TComTrmSetForm(Classes::TComponent* AOwner, int 
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TComTrmSetForm(HWND ParentWindow) : Forms::TForm(
		ParentWindow) { }
	#pragma option pop
