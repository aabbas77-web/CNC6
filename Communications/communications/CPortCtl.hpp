...
// (DO NOT EDIT: machine generated header) 'CPortCtl.pas' rev: 5.00
...
public:
	...
	void __fastcall Change(AnsiString Text);
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TComComboBox(HWND ParentWindow) : Stdctrls::TCustomComboBox(
		ParentWindow) { }
	#pragma option pop
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TComRadioGroup(HWND ParentWindow) : Extctrls::TCustomRadioGroup(
		ParentWindow) { }
	#pragma option pop
...
private:
	...
	Cport::TComLedSignal FLedSignal;
	TLedKind FKind;
	TLedState FState;
	...
	void __fastcall SetLedSignal(const Cport::TComLedSignal Value);
	...
	Windows::TPoint __fastcall CalcBitmapPos(void);
...
__published:
	...
	__property Cport::TComLedSignal LedSignal = {read=FLedSignal, write=SetLedSignal, nodefault};
...
typedef void __fastcall (__closure *TEscapeEvent)(System::TObject* Sender, Cportesc::TEscapeCodes* &
	EscapeCodes);

typedef void __fastcall (__closure *TUnhandledEvent)(System::TObject* Sender, Cportesc::TEscapeCode 
	Code, AnsiString Data);
...
private:
	...
	TTermCaret FCaret;
	Windows::TPoint FCaretPos;
	Windows::TPoint FSaveCaret;
	bool FCaretCreated;
	Windows::TPoint FTopLeft;
	int FCaretHeight;
	...
	void __fastcall InvalidatePortion(const Windows::TRect &ARect);
	...
	void __fastcall PaintTerminal(const Windows::TRect &Rect);
...
public:
	...
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TCustomComTerminal(HWND ParentWindow) : Controls::TCustomControl(
		ParentWindow) { }
	#pragma option pop
...
__published:
	...
	__property SendLF ;
	__property ShowHint ;
	__property SmoothScroll ;
	__property TabOrder ;
	__property TabStop ;
	__property Caret ;
	__property Visible ;
	__property WrapLines ;
	__property Anchors ;
	__property AutoSize ;
	__property Constraints ;
	__property DragKind ;
...
public:
	#pragma option push -w-inl
	/* TCustomComTerminal.Create */ inline __fastcall virtual TComTerminal(Classes::TComponent* AOwner)
		 : TCustomComTerminal(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TComTerminal(HWND ParentWindow) : TCustomComTerminal(
		ParentWindow) { }
	#pragma option pop
