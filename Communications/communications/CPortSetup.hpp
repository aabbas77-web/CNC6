...
// (DO NOT EDIT: machine generated header) 'CPortSetup.pas' rev: 5.00
...
public:
	...
	/* TCustomForm.Create */ inline __fastcall virtual TComSetupFrm(Classes::TComponent* AOwner) : Forms::TForm(
		AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
	/* TCustomForm.CreateNew */ inline __fastcall virtual TComSetupFrm(Classes::TComponent* AOwner, int 
