...
// perform asynchronous write operation
function TCustomComPort.WriteStrAsync(Str: string; var AsyncPtr: PAsync): Integer;
var
  Success: Boolean;
  BytesTrans: DWORD;
begin
...
procedure TCustomComPort.SendSignals(Signal: TComLedSignal; OnOff: Boolean);
var
  I: Integer;
  ComLink: TComLink;
...
procedure TComDataPacket.HandleBuffer;
  ...
  begin
    ...
    begin
      ...
      if Found > 0 then
      begin
        // start string found in buffer, start packet
        Str := Copy(Buffer, 1, Found - 1); // some discarded data
